...
var persona = new Usuario('david', 60, 'ejemplo@p.es');
document.write(persona.mostrarInfo());

var Student = /*#__PURE__*/function (_Usuario) {
  _inherits(Student, _Usuario);

  var _super = _createSuper(Student);

  function Student(nombre, edad, correo, carrera) {
    var _this;
...
var persona1 = new Student('ramon', 90, 'p@p.es', 'bombero');
