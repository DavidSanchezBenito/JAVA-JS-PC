...
function validaNombre() {
    ...
    if (elemento.value == "") {
        ...
        error(elemento);  //si da error se aplica formato a este campo
        return false;
    }
    return true;
}
...
function error(elemento) {
    ...
    elemento.focus();   //con esto coge el foco para q marque el campo con errores
}

function limpiarError(elemento) {   //sirve para limpiar la clase error
    elemento.className = "";  //asi quitamos la clase
}